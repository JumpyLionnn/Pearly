...
namespace Pearly {
	...
	private:
		...
		static void SubmitQuadVertecies(const glm::mat4&, uint32 textureIndex, const glm::vec4& color, float tilingFactor, const std::array<glm::vec2, 4>& textureCoords, int entityID = -1);
