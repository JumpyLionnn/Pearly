...
namespace Pearly {
    ...
    bool ImGuiLayer::OnKeyPressed(KeyPressedEvent& e)
    {
        ...
        io.KeyCtrl = io.KeysDown[KeyToImGuiKey(GLFW_KEY_LEFT_CONTROL)] || io.KeysDown[KeyToImGuiKey(GLFW_KEY_RIGHT_CONTROL)];
        io.KeyShift = io.KeysDown[KeyToImGuiKey(GLFW_KEY_LEFT_SHIFT)] || io.KeysDown[KeyToImGuiKey(GLFW_KEY_RIGHT_SHIFT)];
        io.KeyAlt = io.KeysDown[KeyToImGuiKey(GLFW_KEY_LEFT_ALT)] || io.KeysDown[KeyToImGuiKey(GLFW_KEY_RIGHT_ALT)];
        io.KeySuper = io.KeysDown[KeyToImGuiKey(GLFW_KEY_LEFT_SUPER)] || io.KeysDown[KeyToImGuiKey(GLFW_KEY_RIGHT_SUPER)];
